...
typedef int (__stdcall *CompileMethodHandler)(ULONG_PTR classthis, 
											  ICorJitInfo *comp,
...
typedef int (__stdcall *jitNativeCodeHandler)(ULONG_PTR classthis, 
											  ICorJitInfo *comp,
											  CORINFO_METHOD_INFO *info,
											  unsigned flags,
											  BYTE **nativeEntry, 
...
typedef int (__stdcall *CompCompileHandler)(ULONG_PTR classthis, 
											  ICorJitInfo *comp,
											  CORINFO_METHOD_INFO *info,
											  unsigned flags,
											  BYTE **nativeEntry, 
